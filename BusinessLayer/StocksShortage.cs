...
namespace BusinessLayer
{
    public class StocksShortage
    {
        ...
        public IEnumerable<BusinessModels.Stocks> GetAllStockShortage()
        {
            return _dataLayer.GetAllStocksShortage();
        }
       
        public IEnumerable<BusinessModels.Stocks> GetAllStockShortage(int locID)
        {
            return _dataLayer.GetAllStockShortage(locID);
        }
        public IEnumerable<BusinessModels.Stocks> GetAllStockShortage(int locID, int empID)
        {
            return _dataLayer.GetAllStocksShortage(locID,empID);
        }
