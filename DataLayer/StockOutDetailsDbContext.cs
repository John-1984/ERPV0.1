...
namespace DataLayer
{
    ...
    public partial class StockOutDetailsDbContext : DbContext
    {
        public StockOutDetailsDbContext() : base("LocalMySqlServer")
        {
        ...
        public DbSet<BusinessModels.StockOutDetails> StockOutDetails { get; set; }
